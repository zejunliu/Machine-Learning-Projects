...
def generate_data_perceptron(nb_features=2, seperation=2) -> Tuple[List[List[float]], List[int]]:
    ...
    x, y = make_classification(n_samples=100, n_features=nb_features, n_informative=2, n_redundant=0, n_classes=2, n_clusters_per_class=2,weights=None, flip_y=0.00, class_sep=seperation, hypercube=True, shift=0.0, scale=1.0, shuffle=True, random_state=500)
    y = 2 * y - 1
